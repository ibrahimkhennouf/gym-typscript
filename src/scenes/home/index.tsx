  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      <motion.div
        ...
        onViewportEnter={handleGetBackToHome}
      >
        {/* MAIN HEADER */}
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              ...
              ad illo corporis, magni, maiores eveniet incidunt provident
              officia, quam id aliquid dolores at aliquam. Dolorum in eveniet
              error ipsa!
            </p>
          </motion.div>
          {/* ACTIONS */}
        ...
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6">
            <div className="flex items-center justify-between w-3/5 gap-8">
              ...
              <img src={SponsorForbes} alt="fobres-sponsor" />
